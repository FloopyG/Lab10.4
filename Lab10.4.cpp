/*
Створити текстовий файл, який містить додатні, від’ємні, нульові числа та довільні символи. 
...
void addToFileC(char* fname, int plus, int minus, int zero, int word);
